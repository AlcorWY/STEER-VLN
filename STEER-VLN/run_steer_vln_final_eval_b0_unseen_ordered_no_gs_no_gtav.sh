...
TAG="B0_original_openfly_baseline_unseen_ordered_no_gs_no_gtav"
...
echo "============================================================"
echo "[B0 ONLY / UNSEEN / NO_GS_NO_GTAV] Original OpenFly baseline"
...
echo "============================================================"
echo "[DONE] B0 unseen no_gs_no_gtav finished"
echo "[SAVED] ${LOG}"
echo "============================================================"
